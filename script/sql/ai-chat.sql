...
-- 运营平台
INSERT INTO `sys_menu` VALUES (1787684619807227905, '运营平台', 0, 1, 'platform', NULL, NULL, 1, 0, 'M', '0', '0', NULL, '', 103, 1, '2024-05-07 11:23:22', 1, '2024-05-07 11:23:22', '');
INSERT INTO `sys_menu` VALUES (1787684775084556290, '模型管理', 1787684619807227905, 1, 'model', NULL, NULL, 1, 0, 'M', '0', '0', NULL, '', 103, 1, '2024-05-07 11:23:59', 1, '2024-05-07 11:23:59', '');
-- 模型信息
INSERT INTO `sys_menu` VALUES (1787685170473205762, '模型信息', 1787684775084556290, 1, 'model', 'gpt/model/index', NULL, 1, 0, 'C', '0', '0', 'gpt:model:list', '#', 103, 1, '2024-05-07 11:26:19', NULL, NULL, '模型信息菜单');
INSERT INTO `sys_menu` VALUES (1787685170473205763, '模型信息查询', 1787685170473205762, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:model:query', '#', 103, 1, '2024-05-07 11:26:19', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685170473205764, '模型信息新增', 1787685170473205762, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:model:add', '#', 103, 1, '2024-05-07 11:26:19', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685170473205765, '模型信息修改', 1787685170473205762, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:model:edit', '#', 103, 1, '2024-05-07 11:26:19', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685170473205766, '模型信息删除', 1787685170473205762, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:model:remove', '#', 103, 1, '2024-05-07 11:26:19', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685170473205767, '模型信息导出', 1787685170473205762, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:model:export', '#', 103, 1, '2024-05-07 11:26:19', NULL, NULL, '');
-- 搜索引擎
INSERT INTO `sys_menu` VALUES (1787685171320455169, '搜索引擎', 1787684775084556290, 1, 'searchEngine', 'gpt/searchEngine/index', NULL, 1, 0, 'C', '0', '0', 'gpt:searchEngine:list', '#', 103, 1, '2024-05-07 11:26:35', NULL, NULL, '搜索引擎菜单');
INSERT INTO `sys_menu` VALUES (1787685171320455170, '搜索引擎查询', 1787685171320455169, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:searchEngine:query', '#', 103, 1, '2024-05-07 11:26:35', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685171320455171, '搜索引擎新增', 1787685171320455169, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:searchEngine:add', '#', 103, 1, '2024-05-07 11:26:35', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685171320455172, '搜索引擎修改', 1787685171320455169, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:searchEngine:edit', '#', 103, 1, '2024-05-07 11:26:35', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685171320455173, '搜索引擎删除', 1787685171320455169, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:searchEngine:remove', '#', 103, 1, '2024-05-07 11:26:35', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1787685171320455174, '搜索引擎导出', 1787685171320455169, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:searchEngine:export', '#', 103, 1, '2024-05-07 11:26:35', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793204907755094018, '会话管理', 1787684619807227905, 1, 'chat', NULL, NULL, 1, 0, 'M', '0', '0', NULL, '', 103, 1, '2024-05-22 16:59:01', 1, '2024-05-22 16:59:01', '');
-- 对话
INSERT INTO `sys_menu` VALUES (1793205858788360193, '对话', 1793204907755094018, 1, 'chat', 'gpt/chat/index', NULL, 1, 0, 'C', '0', '0', 'gpt:chat:list', '#', 103, 1, '2024-05-22 17:03:16', 1, '2024-05-22 17:21:54', '对话菜单');
INSERT INTO `sys_menu` VALUES (1793205858788360194, '对话查询', 1793205858788360193, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chat:query', '#', 103, 1, '2024-05-22 17:03:16', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205858788360195, '对话新增', 1793205858788360193, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chat:add', '#', 103, 1, '2024-05-22 17:03:16', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205858788360196, '对话修改', 1793205858788360193, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chat:edit', '#', 103, 1, '2024-05-22 17:03:16', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205858788360197, '对话删除', 1793205858788360193, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chat:remove', '#', 103, 1, '2024-05-22 17:03:16', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205858788360198, '对话导出', 1793205858788360193, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chat:export', '#', 103, 1, '2024-05-22 17:03:16', NULL, NULL, '');
-- 对话消息
INSERT INTO `sys_menu` VALUES (1793205859568500737, '对话消息', 1793204907755094018, 1, 'chatMessage', 'gpt/chatMessage/index', NULL, 1, 0, 'C', '0', '0', 'gpt:chatMessage:list', '#', 103, 1, '2024-05-22 17:03:32', 1, '2024-05-22 17:22:08', '对话消息菜单');
INSERT INTO `sys_menu` VALUES (1793205859568500738, '对话消息查询', 1793205859568500737, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chatMessage:query', '#', 103, 1, '2024-05-22 17:03:32', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205859568500739, '对话消息新增', 1793205859568500737, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chatMessage:add', '#', 103, 1, '2024-05-22 17:03:32', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205859568500740, '对话消息修改', 1793205859568500737, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chatMessage:edit', '#', 103, 1, '2024-05-22 17:03:32', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205859568500741, '对话消息删除', 1793205859568500737, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chatMessage:remove', '#', 103, 1, '2024-05-22 17:03:32', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793205859568500742, '对话消息导出', 1793205859568500737, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:chatMessage:export', '#', 103, 1, '2024-05-22 17:03:32', NULL, NULL, '');
-- AI助手
INSERT INTO `sys_menu` VALUES (1793495817076252673, 'AI助手', 1793204907755094018, 1, 'assistant', 'gpt/assistant/index', NULL, 1, 0, 'C', '0', '0', 'gpt:assistant:list', '#', 103, 1, '2024-05-23 12:15:18', NULL, NULL, 'AI助手菜单');
INSERT INTO `sys_menu` VALUES (1793495817076252674, 'AI助手查询', 1793495817076252673, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:assistant:query', '#', 103, 1, '2024-05-23 12:15:18', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793495817076252675, 'AI助手新增', 1793495817076252673, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:assistant:add', '#', 103, 1, '2024-05-23 12:15:18', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793495817076252676, 'AI助手修改', 1793495817076252673, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:assistant:edit', '#', 103, 1, '2024-05-23 12:15:18', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793495817076252677, 'AI助手删除', 1793495817076252673, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:assistant:remove', '#', 103, 1, '2024-05-23 12:15:18', NULL, NULL, '');
INSERT INTO `sys_menu` VALUES (1793495817076252678, 'AI助手导出', 1793495817076252673, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'gpt:assistant:export', '#', 103, 1, '2024-05-23 12:15:18', NULL, NULL, '');
...
CREATE TABLE `gpt_assistant`  (
    `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '主键',
    `name` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '助手名称',
    `icon` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图标',
    `model` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所属模型',
    `description` varchar(900) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '描述',
    `greet` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '招呼语',
    `system_prompt` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '系统提示',
    `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '租户号',
    ...
    `del_flag` int NULL DEFAULT 0 COMMENT '删除标识'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI助手' ROW_FORMAT = Dynamic;
...
CREATE TABLE `gpt_chat`  (
    ...
    `content_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '内容类型：text：文字 image : 图片',
    `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '租户号',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '对话' ROW_FORMAT = Dynamic;


DROP TABLE IF EXISTS `gpt_chat_message`;
CREATE TABLE `gpt_chat_message`  (
    `id` bigint NOT NULL COMMENT '主键',
    `chat_id` bigint NULL DEFAULT NULL COMMENT '对话ID',
    `message_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '消息ID',
    `parent_message_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '回复消息ID',
    `model` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模型',
    `model_version` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模型版本',
    ...
    `images` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片内容',
    `content_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '内容类型：text：文字 image : 图片',
    `finish_reason` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '结束原因',
    `status` int NULL DEFAULT NULL COMMENT '状态',
    `total_tokens` int NULL DEFAULT NULL COMMENT '使用token',
    `response` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '响应全文',
    `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '租户号',
    `dept_id` bigint NULL DEFAULT NULL COMMENT '部门ID',
    `user_id` bigint NULL DEFAULT NULL COMMENT '用户Id',
    `version` int NULL DEFAULT NULL COMMENT '乐观锁',
    ...
    `del_flag` int NULL DEFAULT 0 COMMENT '删除标识',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '对话消息' ROW_FORMAT = Dynamic;

DROP TABLE IF EXISTS `gpt_model`;
CREATE TABLE `gpt_model`  (
    `id` bigint NOT NULL COMMENT '主键',
    `type` int NULL DEFAULT NULL COMMENT '模型类型;',
    `name` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '名称',
    `icon` bigint NULL DEFAULT NULL COMMENT '图标',
    `value` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '模型值',
    `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '租户号',
    `dept_id` bigint NULL DEFAULT NULL COMMENT '部门ID',
    `user_id` bigint NULL DEFAULT NULL COMMENT '用户Id',
    `version` int NULL DEFAULT NULL COMMENT '乐观锁',
    ...
    `del_flag` int NULL DEFAULT 0 COMMENT '删除标识',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '模型信息表' ROW_FORMAT = Dynamic;


DROP TABLE IF EXISTS `gpt_search_engine`;
CREATE TABLE `gpt_search_engine`  (
    `id` bigint NOT NULL COMMENT '主键',
    `name` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '名称',
    `value` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '值',
    `used` int NULL DEFAULT NULL COMMENT '是否使用',
    `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '租户号',
    `dept_id` bigint NULL DEFAULT NULL COMMENT '部门ID',
    `user_id` bigint NULL DEFAULT NULL COMMENT '用户Id',
    `version` int NULL DEFAULT NULL COMMENT '乐观锁',
    ...
    `del_flag` int NULL DEFAULT 0 COMMENT '删除标识',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '搜索引擎' ROW_FORMAT = Dynamic;
